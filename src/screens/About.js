    ...
    if (!fontsLoaded) {
        ...
        return (
            <View style={styles.aboutContainer}>
                <Text style={styles.mainHeader}> Himanshu Dixit </Text>
                ...
                <View style={styles.menuContainer}>
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            Linking.openURL("https://www.instagram.com/dhimanshu_02/")
                        }>
                        <Image
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            Linking.openURL(
                                "https://www.instagram.com/dhimanshu_02/"
                            )
                        }>
                        <Image
                            style={styles.iconStyle}
                    ...
                    <TouchableOpacity
                        style={styles.buttonStyle}
                        onPress={() => Linking.openURL("https://www.instagram.com/dhimanshu_02/")}>
                        <Image
                            style={styles.iconStyle}
                            source={{
